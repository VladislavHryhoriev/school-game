...
export const v0938en = {
	...
	content: {
		new: `
			...
			- A new button has been added to the biography menu: physical data. There you can see the full height of the randomized NPS, as well as his weight, which is counted using the difference of his physical attributes, some features of appearance, body type and other variables.
